#!/usr/bin/env python3
'''
This file is from https://github.com/NVIDIA-AI-IOT/jetson-multicamera-pipelines 
This file includes the basic functions for multipipeline cameras
'''
...
def _sanitize(element) -> Gst.Element:
    """
    Pass through function which sure element is not `None`
